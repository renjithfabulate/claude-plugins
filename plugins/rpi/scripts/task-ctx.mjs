...
//
// Every /rpi:* phase skill injects this instead of guessing at filenames.
//
...
function loadConfig(root) {
  const path = join(root, '.rpi', 'config.json');
  if (!existsSync(path)) return { ...DEFAULTS, _source: null };
  try {
