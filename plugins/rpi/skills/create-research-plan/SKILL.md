...
effort: high
allowed-tools: Bash(node ${CLAUDE_PLUGIN_ROOT}/scripts/task-ctx.mjs *), Read, Grep, Glob, Write
---
...
If there is no `ticket.md`, stop and point the user at `/rpi:start-task`.
